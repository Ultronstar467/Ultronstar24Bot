...
async def _240(event):
    ...
    if not os.path.isdir("encodemedia"):
        ...
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 426x240 -crf 28 -c:a libopus -ac 2 -ab 128k -c:s copy'
...
async def _360(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 640x360 -crf 28 -c:a libopus -ac 2 -ab 128k -c:s copy'
        await encode(event, msg, cmd)        
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _480(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 854x480 -crf 28 -c:a libopus -ac 2 -ab 128k -c:s copy'
        await encode(event, msg, cmd)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _576(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 1024x576 -crf 28 -c:a libopus -ac 2 -ab 192k -c:s copy'
        await encode(event, msg, cmd)       
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _720(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 1280x720 -crf 28 -c:a libopus -ac 2 -ab 192k -c:s copy'
        await encode(event, msg, cmd)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _1080(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia") 
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 1920x1080 -crf 28 -c:a libopus -ac 2 -ab 192k -c:s copy'
        await encode(event, msg, cmd)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _2160(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia") 
        cmd = '-c:v libx265 -pix_fmt yuv420p -preset ultrafast -s 3840x2160 -crf 28 -c:a libopus -ac 2 -ab 128k -c:s copy'
        await encode(event, msg, cmd)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
