...
async def _360(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        await encode(event, msg, scale=640 x 360)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _480(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        await encode(event, msg, scale=640×480)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _576(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        await encode(event, msg, scale=720 x 576)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
...
async def _720(event):
    ...
    if not os.path.isdir("encodemedia"):
        await event.delete()
        os.mkdir("encodemedia")
        await encode(event, msg, scale=1280 x 720)
        os.rmdir("encodemedia")
    else:
        await event.edit("Another process in progress!")
